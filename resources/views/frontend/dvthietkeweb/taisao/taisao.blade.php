            ...
            <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="textDescribeTaiSao">
                        ...
                        <ul>
                            <li class="wow fadeInRight" data-wow-delay="0.5s">Chúng tôi chỉ nhận thiết kế website theo
                                yêu
                                cầu quý khách, không theo mẫu cố định
                            </li>
                            <li class="wow fadeInRight" data-wow-delay="1s">Mỗi khách hàng sẽ có một website hoàn toàn
                                khác
                                nhau, phong cách khác nhau
                            </li>
                            <li class="wow fadeInRight" data-wow-delay="1.5s">Chúng tôi đảm bảo website quý khách được
                                thiết
                                kế với kỹ thuật mới nhất phù hợp với xu hướng hiện nay
                            </li>
                            <li class="wow fadeInRight" data-wow-delay="2.5s">Đảm bảo quý khách có một website hoàn hảo
                                đại
